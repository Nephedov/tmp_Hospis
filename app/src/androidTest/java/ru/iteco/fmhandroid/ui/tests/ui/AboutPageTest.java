...
//
//        AboutPage.versionText.checkWithTimeout(matches(isDisplayed())).check(matches(withText(versionText)));
//        AboutPage.versionNumber.checkWithTimeout(matches(isDisplayed())).check(matches(withText(versionNumber)));
//    }
//
//    @Epic(value = "Тестирование UI")
//    @Feature(value = "Страница \"О приложении\"")
...
//
//        AboutPage.privacyPolicyText.checkWithTimeout(matches(isDisplayed())).check(matches(withText(privacyPolicyText)));
//        AboutPage.privacyPolicyLink.checkWithTimeout(matches(isDisplayed())).check(matches(withText(privacyPolicyLink)));
//    }
//    @Epic(value = "Тестирование UI")
//    @Feature(value = "Страница \"О приложении\"")
...
//
//        AboutPage.termOfUseText.checkWithTimeout(matches(isDisplayed())).check(matches(withText(privacyPolicyText)));
//        AboutPage.termOfUseLink.checkWithTimeout(matches(isDisplayed())).check(matches(withText(privacyPolicyLink)));
//    }
//
//    @Epic(value = "Тестирование UI")
//    @Feature(value = "Страница \"О приложении\"")
...
//
//        AboutPage.aboutLabel.checkWithTimeout(matches(isDisplayed())).check(matches(withText(aboutLabel)));
//    }
//}
